...
Edited Version from original source. This is version 2.0
"""
...
# Edited version
def make_vcsp(lib_name, lib_path, md5_enabled, image_list, short_name):
...
def main():
    ...
    if "local" == storage_type:
        make_vcsp(lib_name, lib_path, md5_enabled, image_list, short_name)
